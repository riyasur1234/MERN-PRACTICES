...
const CompleteTask = ({ data }) => {
  return (
    <div className='flex-shrink-0 h-[90%] w-[300px] bg-gradient-to-br from-green-500 to-green-600 rounded-2xl p-6 shadow-xl shadow-green-500/30 hover:shadow-green-500/50 transition-all duration-300 hover:scale-105'>
